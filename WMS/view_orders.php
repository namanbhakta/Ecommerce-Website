<table width="795" align="center" bgcolor="pink"> 
	...
	$get_ord = "select * from orders where order_status='pending'";
	...
	<tr align="center">
		...
		<td><a href="http://192.168.137.148?process_ord=<?php echo $ord_id;?>&cus_email=<?php echo $ord_email;?>">Process</a></td>
