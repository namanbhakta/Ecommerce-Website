	...
	<form action="" method="post" enctype="multipart/form-data"> 
		...
		<table align="center" width="795" border="2" bgcolor="#187eae">
			...
			<tr>
				...
				<td>
				<select name="product_cat" disabled >
		...
		echo "<option value='$cat_id'>$cat_title</option>";
			...
			<tr>
				...
				<td>
				<select name="product_brand" disabled >
...
<?php 
	...
	if(isset($_POST['update_product'])){
		...
		move_uploaded_file($product_image_tmp,"product_images/$product_image");
		 ...
		 $update_product = "update products set product_title='$product_title',product_price='$product_price',product_desc='$product_desc',product_image='$product_image', product_keyword='$product_keywords' where product_id='$update_id'";
